    ...
    def do_POST(self):
        try:
            ...
            if self.path == '/scheduleAppointment':
                ...
                appointment_time = form.getvalue("appointemnt_time")

                self.database.scheduleAppointment(patient_id, doctor_id, appointment_date, appointment_time)
            
                print("scheduleAppointment:", patient_id, doctor_id, appointment_date, appointment_time)
                ...
                self.wfile.write(b"<div><a href='/scheduleAppointment'>AMake Another Appointment</a></div>")
                self.wfile.write(b"</center></body></html>")
                ...
                self.wfile.write(b"<div><a href='/dischargePatient'>Discharge Patient</a></div>")
                self.wfile.write(b"</center></body></html>")
        ...
        try:
            ...
            if  self.path == '/':
                ...
                self.wfile.write(b"<div> <a href='/'>Home</a>| \
                                 <a href='/addPatient'>Add Patient</a>|\
                                  ...
                                  <a href='/dischargePatient'>Discharge Patient</a></div>\
                                  <a href='/updatePatientDetails'>Update Patient Details</a></div>\
                                  <a href='/viewAllDoctors'>Doctors</a></div>")
            ...
            if self.path == '/scheduleAppointment':
                ...
                self.wfile.write(b'<label for="patient_id">Patient ID:</label>\
                      ...
                      <label for="appointment_date">Admission Date:</label>\
            ...
            if self.path == '/viewAppointments':
                ...
                self.wfile.write(b"<div> <a href='/'>Home</a>| \
                                 <a href='/addPatient'>Add Patient</a>|\
                                  ...
                                  <a href='/dischargePatient'>Discharge Patient</a></div>\
                                  <a href='/updatePatientDetails'>Update Patient Details</a></div>\
                                  <a href='/viewDoctors'>View All Doctors</a></div>")
...
def run(server_class=HTTPServer, handler_class=HospitalPortalHandler, port=8001):
